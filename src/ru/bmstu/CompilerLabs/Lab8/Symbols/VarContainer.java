...
public class VarContainer extends Var {
    private ArrayList<Symbol> elements;

    public VarContainer() {
        super(VarTag.CONTAINER);
    ...
    public VarContainer clone() throws CloneNotSupportedException {
        VarContainer vc = new VarContainer();
        vc.elements.addAll(this.elements);
        return vc;
    }
}
